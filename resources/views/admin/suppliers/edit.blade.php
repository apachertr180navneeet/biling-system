            ...
            <form method="POST" action="{{ route('admin.suppliers.update', $supplier) }}">
                ...
                <div class="mb-3">
                    ...
                    <select name="type" class="form-control @error('type') is-invalid @enderror">
                        ...
                        <option value="OEM" {{ old('type', $supplier->type) == 'OEM' ? 'selected' : '' }}>OEM</option>
                        <option value="parts_vendor" {{ old('type', $supplier->type) == 'parts_vendor' ? 'selected' : '' }}>Parts Vendor</option>
                    </select>
