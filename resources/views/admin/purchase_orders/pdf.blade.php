        ...
        <tr>
            ...
            <td>
                ...
                <div class="po-meta">
                    ...
                    <strong>Date:</strong> {{ $purchaseOrder->order_date->format('d-m-Y') }}
                </div>
            </td>
        </tr>
    </table>
            ...
            <td class="info-col">
                <div class="info-card">
                    ...
                    @if(!empty($purchaseOrder->supplier->address))
                        <strong>Address:</strong> {{ $purchaseOrder->supplier->address }}<br>
                    @endif
                </div>
            </td>
            <td class="info-col">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span style="font-size: 9px; color: #666;">Part No: {{ $item->sparePart->part_no ?? '-' }}</span>
                </td>
