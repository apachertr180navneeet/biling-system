            ...
            <form method="POST" action="{{ route('admin.purchase-orders.store') }}" id="poForm">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="notes" class="form-control @error('notes') is-invalid @enderror" rows="2" placeholder="Order notes or reference details...">{{ old('notes') }}</textarea>
                ...
                <div class="card mb-4 bg-light border border-light-subtle">
                    <div class="card-body text-end py-3">
                        <h4 class="mb-0">Grand Total: ₹ <span id="grandTotal" class="text-primary fw-bold">0.00</span></h4>
                    </div>
                </div>

                <div class="mt-4">
                    <button type="submit" class="btn btn-primary"><i class="bx bx-check"></i> Create Order</button>
