...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Admin / Purchase Orders /</span> Outstanding
    </h4>

    <!-- Search filter -->
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.purchase-orders.outstanding') }}">
                <div class="row g-3">
                    <div class="col-md-9">
                    ...
                    <div class="col-md-3">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.purchase-orders.outstanding') }}" class="btn btn-outline-secondary"><i class="bx bx-reset"></i> Reset</a>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Outstanding Purchase Orders</h5>
            <div>
                <a href="{{ route('admin.purchase-orders.outstanding.export', ['search' => request('search')]) }}" class="btn btn-outline-success me-2"><i class="bx bx-file-export"></i> Export</a>
                <a href="{{ route('admin.purchase-orders.index') }}" class="btn btn-outline-secondary">All Orders</a>
            </div>
        </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    @forelse($orders as $order)
                                        ...
                                        <ul class="dropdown-menu action-dropdown-menu">
                                            <li>
                                                <a class="dropdown-item" href="{{ route('admin.purchase-orders.receive', $order) }}">
                                                    <i class="bx bx-package text-success"></i> Receive Items
                                                </a>
                                            </li>
                                            @if($order->balance > 0)
                                            <li>
                                                <a class="dropdown-item receive-payment-btn" href="javascript:void(0)" data-url="{{ route('admin.purchase-orders.receive-payment', $order) }}" data-balance="{{ $order->balance }}">
                        ...
                        @endif
                    @empty
                    <tr><td colspan="10" class="text-center">No outstanding purchase orders found.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
