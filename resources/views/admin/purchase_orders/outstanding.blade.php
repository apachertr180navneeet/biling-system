                ...
                <tbody>
                    @forelse($orders as $order)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.purchase-orders.receive', $order) }}" class="btn btn-sm btn-primary">Receive</a>
                                @if($order->balance > 0)
                        ...
                        @endforeach
                    @empty
                    <tr><td colspan="13" class="text-center">No outstanding purchase orders found.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
