...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Admin / HSN/SAC Master /</span> Create
    </h4>
    <div class="card">
        <div class="card-header"><h5 class="mb-0">New HSN/SAC Code</h5></div>
        <div class="card-body">
            <form method="POST" action="{{ route('admin.hsn-sac-master.store') }}">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" name="cess_rate" class="form-control @error('cess_rate') is-invalid @enderror" value="{{ old('cess_rate', 0) }}">
