...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Admin / Vehicle Sales Invoices /</span> Outstanding
    </h4>

    <!-- Search filter -->
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.vehicle-sales-invoices.outstanding') }}">
                <div class="row g-3">
                    <div class="col-md-9">
                    ...
                    <div class="col-md-3">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.vehicle-sales-invoices.outstanding') }}" class="btn btn-outline-secondary"><i class="bx bx-reset"></i> Reset</a>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Outstanding Vehicle Sales Invoices</h5>
            <div>
                <a href="{{ route('admin.vehicle-sales-invoices.outstanding.export', ['search' => request('search')]) }}" class="btn btn-outline-success me-2"><i class="bx bx-file-export"></i> Export</a>
                <a href="{{ route('admin.vehicle-sales-invoices.index') }}" class="btn btn-outline-secondary">All Invoices</a>
            </div>
        </div>
        <div class="table-responsive text-nowrap">
            <table class="table table-hover">
                ...
                <tbody>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu action-dropdown-menu">
                                    @if($inv->balance > 0)
                                    <li>
                                        <a class="dropdown-item receive-payment-btn" href="javascript:void(0)" data-url="{{ route('admin.vehicle-sales-invoices.receive-payment', $inv) }}" data-balance="{{ $inv->balance }}">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('admin.vehicle-sales-invoices.edit', $inv) }}">
                                            <i class="bx bx-edit text-primary"></i> Edit Invoice
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    @empty
                    <tr><td colspan="10" class="text-center text-muted">No outstanding vehicle sales invoices found.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
