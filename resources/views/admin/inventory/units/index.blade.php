...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="m-page-header">
        <div class="m-page-header-left">
            ...
            <div>
                <h4 class="m-page-title">Inventory Units</h4>
        ...
        @if(auth()->user()->hasPermission('inventory_units.create'))
        <a href="{{ route('admin.inventory.units.create') }}" class="btn btn-primary m-btn-add"><i class="bx bx-plus"></i> Add Unit</a>
        @endif
    </div>

    <div class="card">
        <div class="card-body">
            <table id="unit-table" class="table table-bordered table-striped" style="width:100%">
                <thead><tr><th>#</th><th>Name</th><th>Short Name</th><th>Status</th><th>Actions</th></tr></thead>
            </table>
        </div>
    </div>
</div>
...
@section('script')
<script>
function unitStatusBadge(status, statusUrl) {
    @if(auth()->user()->hasPermission('inventory_units.edit'))
...
function unitActions(row) {
    ...
    @endif
    @if(auth()->user()->hasPermission('inventory_units.delete'))
