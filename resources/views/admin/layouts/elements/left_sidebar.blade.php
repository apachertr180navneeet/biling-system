<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
	...
	<ul class="menu-inner py-1">
		...
		<li class="menu-item {{ request()->routeIs('admin.part-sales-invoices.*') ? 'active' : ''}}">
			<a href="{{route('admin.part-sales-invoices.index')}}" class="menu-link">
				<i class="menu-icon tf-icons bx bx-receipt"></i>
				<div data-i18n="Part Sales Invoices">Part Sales Invoices</div>
			</a>
		</li>
