            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select name="spare_part_id" id="spare_part_id" class="form-select no-select2" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="adjustment_type" id="adjustment_type" class="form-select no-select2" required>
                            ...
                            <option value="out" {{ old('adjustment_type') == 'out' ? 'selected' : '' }}>Stock Out (-)</option>
                        </select>
                    </div>
                    <div class="mb-3">
...
$(document).ready(function() {
    ...
    @if($errors->any())
        var adjustModalModalEl = document.getElementById('adjustStockModal');
        if (adjustModalModalEl) {
            var adjustModal = new bootstrap.Modal(adjustModalModalEl);
            adjustModal.show();
        }
    @endif
});
