                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.vehicle-purchase-orders.whatsapp', $order) }}" class="btn btn-sm btn-success" target="_blank" title="Send WhatsApp"><i class="bx bxl-whatsapp"></i></a>
                            <button class="btn btn-sm btn-danger btn-delete" data-url="{{ route('admin.vehicle-purchase-orders.destroy', $order) }}" title="Delete"><i class="bx bx-trash"></i></button>
                        </td>
                    </tr>
                    @empty
