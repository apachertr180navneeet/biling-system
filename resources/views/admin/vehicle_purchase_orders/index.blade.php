            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu action-dropdown-menu">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('admin.vehicle-purchase-orders.edit', $order) }}">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="openPaymentHistoryModal('vehicle-purchase-order', {{ $order->id }})">
                                            <i class="bx bx-history text-info"></i> Payment History
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ route('admin.vehicle-purchase-orders.whatsapp', $order) }}" target="_blank">
                                            <i class="bx bxl-whatsapp text-success"></i> Send WhatsApp
                                        </a>
                                    </li>
                                    <li><hr class="dropdown-divider my-1"></li>
                                    <li>
                                        <a class="dropdown-item text-danger btn-delete" href="javascript:void(0)" data-url="{{ route('admin.vehicle-purchase-orders.destroy', $order) }}">
                        ...
                        <td><a href="{{ route('admin.vehicle-purchase-orders.show', $order) }}" class="fw-bold">{{ $order->po_number }}</a></td>
