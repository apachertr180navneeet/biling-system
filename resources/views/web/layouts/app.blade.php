...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="@yield('meta_description', config('app.name') . ' - Premium hotel management and direct booking engine')">

        <title>@yield('title', config('app.name'))</title>
        <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets/web/img/favicon.png')}}">
        <link href="https://fonts.googleapis.com/css2?family=Jost:wght@400;500;600;700;800&display=swap" rel="stylesheet">
        <link href="{{asset('assets/web/css/styles.css?v=2.0')}}" rel="stylesheet">
