...
class MasterDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $parts = [
            ['part_no' => 'ENG-001', 'name' => 'Oil Filter', 'category_id' => $engCat->id, 'hsn_code' => '840734', 'purchase_price' => 180, 'selling_price' => 350],
            ['part_no' => 'ENG-002', 'name' => 'Air Filter', 'category_id' => $engCat->id, 'hsn_code' => '840734', 'purchase_price' => 400, 'selling_price' => 750],
            ['part_no' => 'ENG-003', 'name' => 'Fuel Filter', 'category_id' => $engCat->id, 'hsn_code' => '840734', 'purchase_price' => 350, 'selling_price' => 650],
            ['part_no' => 'ENG-004', 'name' => 'Spark Plug', 'category_id' => $engCat->id, 'hsn_code' => '840734', 'purchase_price' => 120, 'selling_price' => 250],
            ['part_no' => 'BRK-001', 'name' => 'Brake Pad Set (Front)', 'category_id' => $brakeCat->id, 'hsn_code' => '870830', 'purchase_price' => 850, 'selling_price' => 1600],
            ['part_no' => 'BRK-002', 'name' => 'Brake Pad Set (Rear)', 'category_id' => $brakeCat->id, 'hsn_code' => '870830', 'purchase_price' => 750, 'selling_price' => 1400],
            ['part_no' => 'BRK-003', 'name' => 'Brake Disc (Front)', 'category_id' => $brakeCat->id, 'hsn_code' => '870830', 'purchase_price' => 1800, 'selling_price' => 3200],
            ['part_no' => 'SUS-001', 'name' => 'Shock Absorber (Front)', 'category_id' => $suspCat->id, 'hsn_code' => '870880', 'purchase_price' => 2200, 'selling_price' => 4000],
            ['part_no' => 'SUS-002', 'name' => 'Shock Absorber (Rear)', 'category_id' => $suspCat->id, 'hsn_code' => '870880', 'purchase_price' => 2000, 'selling_price' => 3600],
            ['part_no' => 'SUS-003', 'name' => 'Tie Rod End', 'category_id' => $suspCat->id, 'hsn_code' => '870880', 'purchase_price' => 450, 'selling_price' => 900],
            ['part_no' => 'ELC-001', 'name' => 'Battery 12V 45Ah', 'category_id' => $elecCat->id, 'hsn_code' => '850710', 'purchase_price' => 3200, 'selling_price' => 5200],
            ['part_no' => 'ELC-002', 'name' => 'Headlight Bulb (H4)', 'category_id' => $elecCat->id, 'hsn_code' => '853921', 'purchase_price' => 180, 'selling_price' => 350],
            ['part_no' => 'ELC-003', 'name' => 'Wiper Blade Set', 'category_id' => $elecCat->id, 'hsn_code' => '851240', 'purchase_price' => 250, 'selling_price' => 500],
            ['part_no' => 'FLT-001', 'name' => 'Engine Oil (5W30) 1L', 'category_id' => $filterCat->id, 'hsn_code' => '271019', 'purchase_price' => 350, 'selling_price' => 650],
            ['part_no' => 'FLT-002', 'name' => 'Engine Oil (5W30) 5L', 'category_id' => $filterCat->id, 'hsn_code' => '271019', 'purchase_price' => 1600, 'selling_price' => 2800],
            ['part_no' => 'FLT-003', 'name' => 'Coolant 1L', 'category_id' => $filterCat->id, 'hsn_code' => '382000', 'purchase_price' => 200, 'selling_price' => 400],
            ['part_no' => 'LGT-001', 'name' => 'LED Headlight Kit', 'category_id' => $lightCat->id, 'hsn_code' => '853950', 'purchase_price' => 1800, 'selling_price' => 3200],
            ['part_no' => 'LGT-002', 'name' => 'Fog Light Assembly', 'category_id' => $lightCat->id, 'hsn_code' => '851220', 'purchase_price' => 1200, 'selling_price' => 2200],
        ];
        foreach ($parts as $p) {
            SparePart::create($p);
        }
